...
3. Add:
	...
	- **Name**: `SUPABASE_URL`
	- **Value**: your Supabase project URL (example: `https://xyzcompany.supabase.co`)
	- **Environment**: Production (and Preview/Development if needed)
...
## Supabase Setup (Auth + Daily Limits)

The app now requires user authentication and enforces the 5/day free limit server-side.
...
4. In **Authentication -> URL Configuration**, set your site URL and redirect URL to your deployed app URL (for password reset)
...
In `app.html`, replace these placeholders:
